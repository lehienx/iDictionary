...
<html>
	...
	<title>iDictionary &mdash; Free Website Template, Free HTML5 Template by gettemplates.co</title>
...
<!-- addd-->
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-sm-2 col-xs-12">
					<p id="gtco-logo">日本語学習</p>
				</div>
				<div class="col-xs-10 text-right menu-1 main-nav">
					<ul>
						<li class="active"><a href="#" data-nav-section="home">ランニング</a></li>
						<li><a href="#" data-nav-section="products">初級</a></li>
						<li><a href="#" data-nav-section="invalite">中級</a></li>
						<li><a href="#" data-nav-section="advanded">上級</a></li>
						<li><a href="#" data-nav-section="news">ニュース</a></li>
						<li><a href="#" data-nav-section="books">本</a></li>
						<li><a href="#" data-nav-section="registeraccount">アカウント登録</a></li>
	...
	<section id="home" class="home bg-black fix" data-section="home">
                ...
                <div class="main_home text-center">
                    <div class="col-md-12">
                        <div class="hello_slid">
                            <div class="slid_item">
                                <div class="home_text ">
                                    <h2 class="text-white"><strong>慎二</strong></h2>
                                    <h1 class="text-white">シンジ</h1>
                                    <h3 class="text-white"><strong>shinji</strong></h3>
                                </div>

                                <div class="home_btns m-top-40">
                                    <a href="" class="btn btn-primary m-top-20">詳細</a>
                                </div>
                            </div>
                            <div class="slid_item">
                                <div class="home_text ">
                                    <h2 class="text-white"><strong>港</strong></h2>
                                    <h1 class="text-white">みなと</h1>
                                    <h3 class="text-white"><strong>minato</strong></h3>
                                </div>
                               ...
                               <div class="slid_item">
                                <div class="home_text ">
                                    <h2 class="text-white"><strong>常に</strong></h2>
                                    <h1 class="text-white">つねに</h1>
                                    <h3 class="text-white"><strong>tsuneni</strong></h3>
                                </div>
...
<!--
	...
	<div class="gtco-section-overflow">
				...
				<div class="row">
                    <div class="col-sm-6">
                        <div class="service coaching">
                            <img src="images/vocabulary.png" alt="" />
                            <a href="Vocabulary.jsp" class="service_btn get_it_btn">Learn More</a>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="service web">
                            <img src="images/kanji.png" alt="" />
                            <a href="Vocabulary.jsp" class="service_btn learn_btn">Learn More</a>
                        </div>
                    </div>
                </div><!--
				<div class="row">
		...
		<div id="gtco-products" data-section="invalite">
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
						<h2>中級</h2>
		...
		<div id="gtco-products" data-section="advanded">
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
						<h2>上級</h2>
	...
	<div id="gtco-blog" data-section="news">
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2>ニュース</h2>
	...
	<div id="gtco-blog" data-section="books">
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2>本</h2>
	...
	<div id="gtco-subscribe" data-section="registeraccount">
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2>アカウント登録</h2>
					...
					<form class="form-inline">
						...
						<div class="col-md-4 col-sm-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="name" placeholder="パスワード">
							</div>
						</div>
						<div class="col-md-4 col-sm-4">
